...
print "<p>See http://php.net/manual/en/ref.array.php for all array functions. Or Google 'php array functions'.</p>";

$associative_array = array('George' => 1982, 'Sally' => 1973, 'Cathy' => 1960,);
